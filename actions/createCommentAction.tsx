...
export default async function createCommentAction(
    ...
    if(!postId) throw new Error("Post Id is a must!");
    if(!commentInput) throw new Error("Provide comment input!");
    ...
    try {
        ...
        throw new Error("Error occurred when posting the comment!!!");
    }
}